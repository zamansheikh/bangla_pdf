...
in these is placed by the shaper, and every word is selectable and searchable.

### চালান · Invoice

A styled table with Bengali digits and the taka sign, built with
`pw.TableHelper.fromTextArray`.

<img src="https://github.com/zamansheikh/bangla_pdf/raw/main/images/sample-invoice.png" alt="A Bangla invoice with a styled table, Bengali digits and taka amounts" width="100%">

### বিজ্ঞপ্তি · Notice

Headings, a justified paragraph and a bulleted list — `pw.Header`,
`pw.Paragraph` and `pw.Bullet`.

<img src="https://github.com/zamansheikh/bangla_pdf/raw/main/images/sample-notice.png" alt="A Bangla government-style notice with headings and bullets" width="100%">

### প্রতিবেদন · Report

Bangla and English in the same paragraphs, in one pass, with no manual
splitting.

<img src="https://github.com/zamansheikh/bangla_pdf/raw/main/images/sample-report.png" alt="A report mixing Bangla and English text" width="100%">

<sub>All three are generated by
...
— run it yourself with <code>dart run tool/dev/make_showcase.dart</code>.</sub>
